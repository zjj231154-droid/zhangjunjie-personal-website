...
export default function Waves({
  ...
  useEffect(() => {
    ...
    function syncBounds({ resizeCanvas = false } = {}) {
      const next = container.getBoundingClientRect();
      boundingRef.current = next;
      if (resizeCanvas || canvas.width !== Math.round(next.width) || canvas.height !== Math.round(next.height)) {
